...
public class PlayerController2D : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        // If the player is moving left but facing right flip the player right
    ...
    // Update is called once per frame. Will update for the jump as we will need every frame. Fixed Update skips frames.
    void Update()
    {
        if(isGrounded)
        {
